...
Ship.prototype.check_general_bomb = function(bs){
    for(k=0; k < bs.length; k++){
	if(this.check_bomb_small(bs[k])){
	    return true;
	}
    }
    return false;
...
Ship.prototype.check_bomb = function(){
    return this.check_general_bomb(bombs);
}

Ship.prototype.check_foebomb = function(){
    return this.check_general_bomb(foebombs);
}
